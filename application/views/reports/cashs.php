	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<div id="table_holder">
						<ul><b style="font-size: large;">Ingresos: </b><?php echo to_currency(($receipt_income+$sales+$open_cash));?>
							<li>
						...
						<b style="font-size: large;">Total: </b><?php echo to_currency(($initial_balance+$receipt_income+$sales+$open_cash));?>
					</div>
				</div>
				<div class="col-md-6">
					<div id="table_holder">
						<ul><b style="font-size: large;">Egresos: </b><?php echo to_currency($receipt_cost);?>
							<li>
								<?php echo 'Recibo de '.$this->lang->line('costs_one_or_multiple') . ': ' .to_currency((!empty($receipt_cost) ? $receipt_cost : 0)); ?>
							</li>
						</ul>
						<ul><b style="font-size: large;">Gastos: </b><?php echo to_currency($expense_amt);?>
						...
						<b style="font-size: large;">Total: </b><?php echo to_currency($receipt_cost+$expense_amt);?>
					</div>
				</div>
			</div>
		</div>
