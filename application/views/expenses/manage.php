...
$(document).ready(function()
{
	...
	// when any filter is clicked and the dropdown window is closed
	$('#expense_categories').on('hidden.bs.select', function(e) {
		table_support.refresh();
	});
	...
	table_support.init({
		...
		queryParams: function() {
			return $.extend(arguments[0], {
				...
				end_date: end_date,
				filters: $("#filters").val() || [""],
				expense_categories: $("#expense_categories").val() || [""]
			});
		}
	});
});
...
<div id="toolbar">
	<div class="pull-left form-inline" role="toolbar">
		<?php if($user_info->username == 'admin' || $user_info->username == 'yGutierrez'): ?>
		...
		<?php echo form_multiselect('expense_categories[]', $expense_categories, '', array('id'=>'expense_categories', 'data-none-selected-text'=>$this->lang->line('common_none_selected_text'), 'class'=>'selectpicker show-menu-arrow', 'data-selected-text-format'=>'count > 1', 'data-style'=>'btn-default btn-sm', 'data-width'=>'fit')); ?>
	</div>
</div>
