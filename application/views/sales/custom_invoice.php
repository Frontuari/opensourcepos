...
$(document).ready(function()
{
	...
	var fiscal_printer = function()
	{
		$.get('<?php echo site_url() . "sales/fiscal_printer/" . $sale_id_num; ?>',
			function(response)
			{
				$.notify(response.message, { type: response.success ? 'success' : 'danger'} );
			}, 'json'
	...
	$("#show_fiscal_printer_button").click(fiscal_printer);
...
<?php endif; ?>
<?php if($this->config->item('fiscal_invoice_enable')):?>
	<script type="text/javascript">
	$(document).ready(function()
	{
...
<div class="print_hide" id="control_buttons" style="text-align:right">
	<?php if($this->config->item('fiscal_invoice_enable')):?>
		<a href="javascript:void(0);"><div class="btn btn-info btn-sm", id="show_fiscal_printer_button"><?php echo '<span class="glyphicon glyphicon-print">&nbsp</span>' . $this->lang->line('common_print'); ?></div></a>
	<?php else: ?>
