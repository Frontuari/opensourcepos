...
class Cashups extends Secure_Controller
{
	...
	public function index()
	{
		...
		$data['cashup_openend'] = $this->Cashup->get_cashup_employee_daily($this->Employee->get_logged_in_employee_info()->person_id,date('Y-m-d'));
	...
	*/
	...
	public function save_income($income_id = -1)
	{
		...
		$cash_ups_info = $this->Cashup->get_cashup_employee_daily($this->Employee->get_logged_in_employee_info()->person_id,date('Y-m-d'));
	...
	*/
	...
	public function view_cost($cost_id = -1)
	{
		...
		$data['cash_ups_info'] = $this->Cashup->get_cashup_employee_daily($this->Employee->get_logged_in_employee_info()->person_id,date('Y-m-d'));
