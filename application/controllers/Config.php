...
class Config extends Secure_Controller
{
	...
	public function save_locations()
	{
		...
		foreach($this->input->post() as $key => $value)
		{
			if(strstr($key, 'stock_location'))
			{
				...
				$array_save[$location_id]['location_name'] = $value;
			}
			elseif(strstr($key, 'stock_code'))
			{
				$location_id = preg_replace("/.*?_(\d+)$/", "$1", $key);
				$array_save[$location_id]['location_code'] = $value;
			}
		}
		...
		if(!empty($array_save))
		{
			...
			{
				// save or update
				$location_data = array('location_code' => $value['location_code'],'location_name' => $value['location_name']);
				if($this->Stock_location->save($location_data, $key))
				{
					$location_id = $this->Stock_location->get_location_id($value['location_name']);
	...
	public function save_cashjournal()
	{

		$batch_save_data = array(
			'cost_number_automatic' => $this->input->post('cost_number_automatic') != NULL,
			'cost_doctype_sequence' => $this->input->post('cost_doctype_sequence'),
			'cost_overallcash_number_automatic' => $this->input->post('cost_overallcash_number_automatic') != NULL,
			'cost_overallcash_doctype_sequence' => $this->input->post('cost_overallcash_doctype_sequence'),
			'expense_number_automatic' => $this->input->post('expense_number_automatic') != NULL,
			'expense_doctype_sequence' => $this->input->post('expense_doctype_sequence'),
			'income_number_automatic' => $this->input->post('income_number_automatic') != NULL,
			'income_doctype_sequence' => $this->input->post('income_doctype_sequence'),
			'income_overallcash_number_automatic' => $this->input->post('income_overallcash_number_automatic') != NULL,
			'income_overallcash_doctype_sequence' => $this->input->post('income_overallcash_doctype_sequence')
		);
