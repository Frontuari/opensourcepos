...
--
-- Servidor: localhost
-- Tiempo de generación: 29-10-2019 a las 10:18:11
...
('cost_number_automatic', '0'),
('cost_overallcash_doctype_sequence', ''),
('cost_overallcash_number_automatic', '0'),
('country_codes', 'us'),
('currency_code', ''),
('currency_decimals', '2'),
('currency_symbol', '$'),
...
('include_hsn', '0'),
('income_doctype_sequence', '1'),
('income_number_automatic', '1'),
('income_overallcash_doctype_sequence', ''),
('income_overallcash_number_automatic', '0'),
...
('admin', '$2y$10$vJBSMlD02EC7ENSrKfVQXuvq9tNRHMtcOA8MSK2NYS748HHWm.gcG', 1, 0, 2, 1, '', '');
...
(NULL, 'John', 'Doe', NULL, '555-555-5555', 'changeme@example.com', 'Address 1', '', '', '', '', '', '', 1);
...
--
ALTER TABLE `ospos_cashup_currencys`
  MODIFY `cashup_currency_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ospos_cash_books`
--
ALTER TABLE `ospos_cash_books`
  MODIFY `cash_book_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ospos_cash_concepts`
--
ALTER TABLE `ospos_cash_concepts`
  MODIFY `cash_concept_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `ospos_cash_daily`
--
ALTER TABLE `ospos_cash_daily`
  MODIFY `cash_daily_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ospos_cash_flow`
--
ALTER TABLE `ospos_cash_flow`
  MODIFY `cash_flow_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ospos_doctype_sequences`
  MODIFY `sequence_id` int(10) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `ospos_overallcash_currencys`
  MODIFY `overallcash_currency_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ospos_overall_cashs`
--
ALTER TABLE `ospos_overall_cashs`
  MODIFY `overall_cash_id` int(10) NOT NULL AUTO_INCREMENT;
